...
def decomposition_prix_valeur():
    ...
    df.to_csv('/home/marinetk/prix_essence/'+'prix' + datetime.today().strftime('%Y-%m-%d') + '.csv')
    print('Fichier des prix CSV enregistré')
   
    new_df.to_csv('/home/marinetk/valeur_100_essence/'+'valeur_100_essence' + datetime.today().strftime('%Y-%m-%d') + '.csv')
